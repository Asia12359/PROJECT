...
var  text1 = document.getElementById("slow1");
...
var text2 = document.getElementById("slow2");
...
var text3 = document.getElementById("slow3");
...
var text4 = document.getElementById("slow4");
...
var text5 = document.getElementById("slow5");
...
var text6 = document.getElementById("slow6");
up6.onclick = function () {
    "use strict";
...
var text7 = document.getElementById("slow7");
up7.onclick = function () {
    "use strict";
...
var text8 = document.getElementById("slow8");
up8.onclick = function () {
    "use strict";
    up8.style.display = "none";
    down8.style.display = "block";
    text8.style.display = "block";

};
down8.onclick = function () {
    "use strict";
